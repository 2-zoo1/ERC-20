...
contract Love is IERC20, Pausable {
    ...
    function _mint(address account, uint256 amount) internal whenNotPaused onlyOwner{
    ...
    function _burn(address account, uint256 amount) internal whenNotPaused onlyOwner{
